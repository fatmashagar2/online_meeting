...
//   void initState() {
//     super.initState();
//     getDeviceToken();  // Make sure to handle the device token properly
//   }
//
//   Future<void> getDeviceToken() async {
//     String? token = await FirebaseMessaging.instance.getToken();
//     if (token != null) {
//       // Store token securely (e.g., SharedPreferences or secure storage)
...
//
//     if (questionText.isEmpty || options.length < 2 || correctAnswer.isEmpty || _selectedDateTime == null) {
...
//         'openAt': _selectedDateTime!.toIso8601String(),
//       });
//
//       await NotificationService.sendNotificationToAll(
//         "سؤال جديد! 🚀",
//         "تم نشر سؤال جديد، اضغط للمشاركة",
//       );
//
//       _clearFields();
//
...
//               title: Text(
//                 _selectedDateTime == null
//                     ? 'Select time to open question'
//                     : 'Selected: ${DateFormat.yMd().add_jm().format(_selectedDateTime!)}',
//               ),
...
///////////////////////////////////////////////كود تست ال one signal مع الفاير بيز
// import 'dart:async';
// import 'package:flutter/material.dart';
// import 'package:cloud_firestore/cloud_firestore.dart';
// import 'package:intl/intl.dart';
